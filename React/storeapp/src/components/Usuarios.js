        ...
        return(
            <div className="mis-usuarios">
                ...
                <nav>
                    <form class="row g-3">
                        <div class="col-auto">
                            ...
                            <input type="text"  class="form-control" id="staticEmail2" placeholder="Cedula"></input>
                        </div>
                        <div class="col-auto">
                            <label for="inputPassword2" class="visually-hidden">nombre</label>
                            <input type="text" class="form-control" id="inputPassword2" placeholder="Nombre"></input>
                        </div>
                        <div class="col-auto">
                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                        <th scope="row">1181932888</th>
                        <td>Karolyn Cabrera</td>
                        <td>kcabrera@gmail.com</td>
                        <td>********</td>
                        <td>Administrador</td>
                        <td>Activo</td>
                        <td><a href="">
                        ...
                        <tr>
                        <th scope="row">111124221</th>
                        <td>Cristian Gonzales</td>
                        <td>cgonzales@gmail.com</td>
                        <td>********</td>
                        <td>Vendedor</td>
                        <td>Activo</td>
                        <td><a href="">
                        ...
                        <tr>
                        <th scope="row">1143555674</th>
                        <td>Luis Escobar</td>
                        <td>lescobar@gmail.com</td>
                        <td>********</td>
                        <td>Vendedor</td>
                        <td>Inactivo</td>
                        <td><a href="">
